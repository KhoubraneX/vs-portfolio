...
window.addEventListener('keydown' , function(e){
  if (getComputedStyle(colorThemeList).display != "none"){
    console.log(e.key);
      switch (e.key){
          case "ArrowUp":
            colorThemeList.querySelectorAll("ul li").forEach(()=>{
              colorThemeList.querySelector('ul li.active-li-manage').classList.remove('active-li-manage')
            })
            colorThemeList.querySelector('ul li.active-li-manage').previousElementSibling.classList.add('active-li-manage')
            break;
      }
  }
})
