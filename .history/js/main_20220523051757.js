  ...
  if (getComputedStyle(colorThemeList).display != "none"){
      switch (e.key){
          case "ArrowUp":
            ...
            // pickcolor
            switch (colorThemeList.querySelector('ul li[name="active-theme"]').dataset.theme){
              case "Dark":
                  this.document.body.cla
                break;
              case "Monokai":
                  this.document.body.classList.add("Monokai")
                break;
              case "shades-of-purple":
                  this.document.body.classList.add("shades-of-purple")
                break;
            }
