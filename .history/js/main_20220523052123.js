      ...
      switch (e.key){
          case "ArrowUp":
            ...
            if (colorThemeList.querySelector('ul li[name="active-theme"]').dataset.theme == "Dark"){
                  ...
                  this.document.body.className = "Monokai"
            }
            if (colorThemeList.querySelector('ul li[name="active-theme"]').dataset.theme == "shades-of-purple"){
                  this.document.body.className = "shades-of-purple"
            }
