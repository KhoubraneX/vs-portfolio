    ...
    console.log(e.key);
      switch (e.key){
          case "ArrowUp":
            ...
            colorThemeList.querySelector('ul li[data-theme="true"]').previousElementSibling.classList.toggle('active-li-manage')
            colorThemeList.querySelector('ul li[data-theme="true"]').previousElementSibling.classList.toggle('active-l
            break;
      }
  }
})
