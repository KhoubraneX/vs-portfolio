  ...
  for (let repos of data) {
    if (repos["name"] != "vs-portfolio") {
      ...
      if (repos["language"] == "JavaScript") {
        li.setAttribute("data-filter", "g-m")
      ...
      } else if (repos["language"] == "CSS") {
        li.setAttribute("data-filter", "p-t-h")
      }
      else if (repos["language"] == "HTML") {
        li.setAttribute("data-filter", "l-p")
      }
